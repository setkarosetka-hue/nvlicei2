...
return (
value?.accepted === true &&
value.version === SYSTEM_CONFIG.rulesVersion
);
}
...
document
.querySelectorAll(
".mobile-menu, .mobile-menu-btn, [data-menu-toggle]"
)
.forEach(button => {
...
document
.querySelectorAll(
"[data-role-only], [data-role-link]"
)
.forEach(element => {
const value =
element.dataset.roleOnly ||
element.dataset.roleLink ||
"";
